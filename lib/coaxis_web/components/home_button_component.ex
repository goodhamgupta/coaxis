  ...
  def render(assigns) do
    ...
    <div>
      <svg
        ...
        style="position: relative; left: -18px; top: 17px;"
        width="30"
        height="31"
        viewBox="0 0 30 31"
        fill="none"
      ...
      <img
        class="rounded-[20px] shrink-0 w-[35px] h-[35px] relative overflow-hidden"
        style="background: linear-gradient(to left, #f6f6f6, #f6f6f6); object-fit: cover; position: relative; left: 33px; top: -15px;"
        src={@profile_picture}
      />
    </div>
    """
