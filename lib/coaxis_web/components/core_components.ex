defmodule CoaxisWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoaxisWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoaxisWeb.Gettext, "errors", msg, opts)
    end
  end
